...
<template>
	<div class="container-fluid login-container-fluid d-flex main flex-column py-4 text-body h-100" 
		...
		<div class="login-box m-auto">
			<div class="m-auto signInContainer modern-login" style="width: 700px;">
		...
		<small class="text-muted pb-3 d-block w-100 text-center mt-3">
			iPWGDashboard {{ this.version }} | Customaized with ❤️ by 
			<a href="https://github.com/iPmartNetwork" target="_blank"><strong>Ali Hassanzadeh</strong></a>
		</small>
...
.modern-login {
	background: linear-gradient(234deg, #041e38, #e7a061);
	padding: 2rem;
	border-radius: 10px;
