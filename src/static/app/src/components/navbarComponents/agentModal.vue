		...
		<div key="header" class="shadow">
			<div class="p-3 d-flex gap-2 flex-column ">
				...
				<div class="list-group">
					<a href="https://donaldzou.github.io/iPWG Dashboard-Documentation/"
...
<!--					<h5 class="mb-0">-->
<!--						<LocaleText t="iPWG Dashboard Help Bot"></LocaleText>-->
<!--					</h5>-->
...
<!--					By using this service, you're agreed to send your messages to a Large Language Model (LLM) hosted on DigitalOcean. Your messages will not store on the server in any type of form, you can verify it on <a href="https://github.com/donaldzou/iPWG Dashboard-Bot-Middleware" target="_blank">here</a>. For more information, please contact me through GitHub or email.-->
<!--				</small>-->
<!--			</div>-->
		</div>
