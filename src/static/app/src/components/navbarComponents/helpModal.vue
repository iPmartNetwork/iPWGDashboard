							...
							<div class="card-body d-flex gap-4 align-items-center">
								...
								<div>
									...
									<small class="text-muted">
										<LocaleText t="Join our Discord server for quick help or chat about iPWG Dashboard!"></LocaleText>
									</small>
								</div>
							</div>
						</a>
						<a class="card text-decoration-none" href="https://donaldzou.github.io/iPWG Dashboard-Documentation/" target="_blank">
							<div class="card-body d-flex gap-4 align-items-center">
								<h1 class="mb-0">
