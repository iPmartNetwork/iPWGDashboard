...
export default {
	...
	data(){
		return{
			activeTab: "iPWGDashboard",
			tabs: [
				{
					id: "iPWGDashboard",
					title: "iPWGDashboard Settings"
				},
				{
					id: "Peers",
...
<template>
	<div class="mt-md-5 mt-3 text-body mb-3" :data-bs-theme="'dark'">
			...
			<div>
				...
				<div>
					<Transition name="fade2" mode="out-in">
						...
						<div class="d-flex gap-3 flex-column" v-else-if="activeTab === 'iPWGDashboard'">
							<div class="card rounded-3">
								<div class="card-header">
									<h6 class="my-2">
